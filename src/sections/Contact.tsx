        ...
        <div className="mx-6 md:mx-10 mt-5 flex flex-col md:flex-row md:flex-wrap mb-3">
          ...
          >
            ...
            <div className="flex flex-col">
              ...
              <p className="text-gray-400 mx-2">johnrowell.lebaste@gmail.com</p>
            </div>
          </a>
          </SlideAnimation>
          <SlideAnimation>
          <a
            href="https://facebook.com/johnrolebaste"
            className="flex flex-row text-sky-300 items-center mt-5 mr-5"
          >
            <Icon className="h-16 w-16" icon="logos:facebook" />
            <div className="flex flex-col">
              <h1 className="text-white text-2xl font-bold mx-2">Facebook</h1>
              <p className="text-gray-400 mx-2">/johnrolebaste</p>
            </div>
          </a>
          </SlideAnimation>
          {/* <SlideAnimation>
          <a
            href="https://www.instagram.com/jhnrlbst"
          ...
          >
            ...
            <div className="flex flex-col">
              ...
              <p className="text-gray-400 mx-2">/@jhnrlbst</p>
            </div>
          </a>
          </SlideAnimation> */}
          <SlideAnimation>
          <a
            href="https://linkedin.com/in/johnrolebaste"
            className="flex flex-row text-sky-300 items-center mt-5 mr-3"
          >
            <Icon className="h-16 w-16" icon="skill-icons:linkedin" />
            <div className="flex flex-col">
              <h1 className="text-white text-2xl font-bold mx-2">Linkedin</h1>
              <p className="text-gray-400 mx-2">/in/johnrolebaste</p>
            </div>
          </a>
          </SlideAnimation>
        </div>
