      ...
      <div className="text-center">
        ...
        <div className="flex justify-center items-center mt-5">
          <ul className="gap-3 flex justify-between items-center sm:gap-12 text-white dark:text-gray-800 w-[calc(100dvw-5rem)] sm:w-fit">
            ...
            <li className="flex flex-col sm:flex-row items-center gap-2">
              <span
                className="flex items-center font-bold text-4xl bg-[#0001] dark:bg-[#fff1] py-1 px-3 rounded-xl"
                id="code-lines"
              >
                &infin;
              </span>
            ...
            <span className="h-8 border-r-[1px] border-dashed border-light-gray-secondary dark:border-dark-gray-secondary"></span>
            <li className="flex flex-col sm:flex-row items-center gap-2">
              <span className="flex items-center font-bold text-4xl bg-[#0001] dark:bg-[#fff1] py-1 px-3 rounded-xl">
                &infin;
              </span>
              <span className="text-[0.71rem] sm:text-[0.81rem] leading-[1] text-center sm:text-left">
                Episodes of anime
        ...
        <div className="text-center w-full mt-7 md:mt-10 ">
          <Button onClick={() => window.open('/Lebaste-John-Rowell.pdf', '_blank') } className="px-5 bg-white text-gray-900 text-md rounded-full mx-3 font-mono hover:bg-white hover:opacity-90 md:scale-150 md:mx-14">
