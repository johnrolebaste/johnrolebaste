    ...
    <SlideAnimation>
      <Card className="bg-gray-800 border-l-0 border-r-0 border-b-0 border-t-[0.4rem] border-sky-300 mt-4 md:max-w-[24rem] md:mx-2">
        ...
        <CardHeader>
          ...
          <a className="text-sky-300" href={link} target="_blank">{title}</a>
          <div className="flex flex-row">
            <a href={link} target="_blank" className="text-white h-5 w-5 mr-4 hover:text-sky-300 transition-all duration-300">
              <Icon icon="fluent:open-48-filled" />
            </a>
            <a href={repo} target="_blank" className="text-white hover:text-sky-300 transition-all duration-300">
